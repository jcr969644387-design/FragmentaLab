...
define una malla en el modulo 1 y todos los demas modulos (calculadora,
...
- **Pantalla de inicio**: accesos a los ocho modulos, incluidos los que no
...
modelo configurable del modulo 2.

## Modulo 2 — Burden y espaciamiento
...
## Modulo 4 — Explosivos (conceptual)
...
Encabeza la pantalla el **tipo de malla simulada**: subterranea, superficial o
ambas, con los cuatro rasgos que sustentan la clasificacion (diametro, altura o
avance, subperforacion y longitud de perforacion) y el rango academico de cada
uno. Asi el estudiante sabe siempre en que contexto minero esta trabajando.

Debajo, vista en planta de la malla con los taladros como circulos y su orden de
salida. Controles rapidos de burden, espaciamiento, diametro, filas, taladros,
geometria de la malla, categoria energetica y secuencia. Indicadores:
uniformidad,
...
2. **Modulo 3**: revisar el significado de los parametros que se van a usar.
3. **Modulo 2**: obtener un burden y un espaciamiento de partida desde el
   diametro y entender de donde salen.
4. **Modulo 1**: completar la malla, leer las validaciones y corregir hasta que
   no queden errores.
5. **Modulo 4**: declarar la categoria energetica y las condiciones de roca y
   agua del ejercicio.
6. **Modulo 5**: elegir un patron de secuencia y observar como cambia la lectura
   de desplazamiento y vibracion.
7. **Modulo 6**: mover un parametro a la vez y observar el efecto sobre los
   indicadores. Esta comparacion es el nucleo del aprendizaje.
8. **Modulo 8**: consultar el diagnostico del ejercicio y las dudas puntuales.
9. **Modulo 7**: rendir la evaluacion y repasar los temas marcados como error.
